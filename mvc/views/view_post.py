...
__CHEETAH_genTime__ = 1300122741.181
__CHEETAH_genTimestamp__ = 'Mon Mar 14 13:12:21 2011'
__CHEETAH_src__ = 'view_post.tmpl'
__CHEETAH_srcLastModified__ = 'Mon Mar 14 13:08:03 2011'
...
\t</div>
''')
        for reply in VFN(VFN(VFSL([locals()]+SL+[globals(), builtin],"board",True),"posts",True)[VFSL([locals()]+SL+[globals(), builtin],"post_num",True)],"replies",True): # generated from line 20, col 1
            write(u'''\t<div class="reply">
\t\t''')
            _v = VFSL([locals()]+SL+[globals(), builtin],"reply",True)['reply-text'] # u"$reply['reply-text']" on line 22, col 3
            if _v is not None: write(_filter(_v, rawExpr=u"$reply['reply-text']")) # from line 22, col 3.
            write(u'''
\t</div>
''')
